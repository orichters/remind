...
*** SOF ./modules/45_carbonprice/NDC_linreg4onlylast/realization.gms
...
$Ifi "%phase%" == "declarations" $include "./modules/45_carbonprice/NDC_linreg4onlylast/declarations.gms"
$Ifi "%phase%" == "datainput" $include "./modules/45_carbonprice/NDC_linreg4onlylast/datainput.gms"
$Ifi "%phase%" == "preloop" $include "./modules/45_carbonprice/NDC_linreg4onlylast/preloop.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/45_carbonprice/NDC_linreg4onlylast/postsolve.gms"
*######################## R SECTION END (PHASES) ###############################

*** EOF ./modules/45_carbonprice/NDC_linreg4onlylast/realization.gms
