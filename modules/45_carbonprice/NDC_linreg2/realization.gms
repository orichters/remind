...
*** SOF ./modules/45_carbonprice/NDC_linreg2/realization.gms
...
$Ifi "%phase%" == "declarations" $include "./modules/45_carbonprice/NDC_linreg2/declarations.gms"
$Ifi "%phase%" == "datainput" $include "./modules/45_carbonprice/NDC_linreg2/datainput.gms"
$Ifi "%phase%" == "preloop" $include "./modules/45_carbonprice/NDC_linreg2/preloop.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/45_carbonprice/NDC_linreg2/postsolve.gms"
*######################## R SECTION END (PHASES) ###############################

*** EOF ./modules/45_carbonprice/NDC_linreg2/realization.gms
