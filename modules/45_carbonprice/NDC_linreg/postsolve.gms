...
*** SOF ./modules/45_carbonprice/NDC_linreg/postsolve.gms
...
If (ord(iteration) < 5,
    ...
    p45_tax_av(p45_NDCyearSet(t,regi)) = sum(iteration2$(ord(iteration2) le ord(iteration)), p45_taxCO2eqSum_iter(iteration2,t,regi))/ord(iteration);
    p45_emi_av(p45_NDCyearSet(t,regi)) = sum(iteration2$(ord(iteration2) le ord(iteration)), p45_CO2eqwoLU_actual_iter(iteration2,t,regi))/ord(iteration);
...
*** EOF ./modules/45_carbonprice/NDC_linreg/postsolve.gms
