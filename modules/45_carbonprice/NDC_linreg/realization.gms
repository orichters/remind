...
*** SOF ./modules/45_carbonprice/NDC_linreg/realization.gms
...
$Ifi "%phase%" == "declarations" $include "./modules/45_carbonprice/NDC_linreg/declarations.gms"
$Ifi "%phase%" == "datainput" $include "./modules/45_carbonprice/NDC_linreg/datainput.gms"
$Ifi "%phase%" == "preloop" $include "./modules/45_carbonprice/NDC_linreg/preloop.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/45_carbonprice/NDC_linreg/postsolve.gms"
*######################## R SECTION END (PHASES) ###############################

*** EOF ./modules/45_carbonprice/NDC_linreg/realization.gms
