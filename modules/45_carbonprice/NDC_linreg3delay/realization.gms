...
*** SOF ./modules/45_carbonprice/NDC_linreg3delay/realization.gms
...
$Ifi "%phase%" == "declarations" $include "./modules/45_carbonprice/NDC_linreg3delay/declarations.gms"
$Ifi "%phase%" == "datainput" $include "./modules/45_carbonprice/NDC_linreg3delay/datainput.gms"
$Ifi "%phase%" == "preloop" $include "./modules/45_carbonprice/NDC_linreg3delay/preloop.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/45_carbonprice/NDC_linreg3delay/postsolve.gms"
*######################## R SECTION END (PHASES) ###############################

*** EOF ./modules/45_carbonprice/NDC_linreg3delay/realization.gms
