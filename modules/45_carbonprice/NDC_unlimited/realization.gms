...
*** SOF ./modules/45_carbonprice/NDC_unlimited/realization.gms
...
$Ifi "%phase%" == "declarations" $include "./modules/45_carbonprice/NDC_unlimited/declarations.gms"
$Ifi "%phase%" == "datainput" $include "./modules/45_carbonprice/NDC_unlimited/datainput.gms"
$Ifi "%phase%" == "preloop" $include "./modules/45_carbonprice/NDC_unlimited/preloop.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/45_carbonprice/NDC_unlimited/postsolve.gms"
*######################## R SECTION END (PHASES) ###############################

*** EOF ./modules/45_carbonprice/NDC_unlimited/realization.gms
