...
pm_taxCO2eq_regi(ttot,all_regi)                           "additional regional CO2 tax path in T$/GtC = $/kgC. To get $/tCO2, multiply with 272 [T$/GtC]"
pm_taxCO2eq_nonregi(ttot,all_regi)                           "save pm_taxCO2eq before adding pm_taxCO2eq_regi: CO2 tax path in T$/GtC = $/kgC. To get $/tCO2, multiply with 272 [T$/GtC]"
