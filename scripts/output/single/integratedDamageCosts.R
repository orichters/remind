...
nodamagefolder <- "/p/tmp/oliverr/NGFS_v4/remind-2023-06-12/output"
nodamagemifs <- file.path(nodamagefolder,
                 c("C_d_delfrag-rem-6/REMIND_generic_C_d_delfrag-rem-6.mif",
                   "C_d_strain-rem-6/REMIND_generic_C_d_strain-rem-6.mif",
                   "C_o_2c_netZero20p-rem-6/REMIND_generic_C_o_2c_netZero20p-rem-6.mif",
                   "C_h_cpol-rem-6/REMIND_generic_C_h_cpol-rem-6.mif",
                   "C_o_lowdem_1Dollar_qtty-rem-6/REMIND_generic_C_o_lowdem_1Dollar_qtty-rem-6.mif",
                   "C_o_1p5c_qtty-rem-6/REMIND_generic_C_o_1p5c_qtty-rem-6.mif",
                   "C_h_ndc-rem-6/REMIND_generic_C_h_ndc-rem-6.mif"))
nodamage <- quitte::as.quitte(nodamagemifs)
levels(nodamage$scenario) <- gsub("_1Dollar|_qtty|_netZero20p", "", levels(nodamage$scenario))
